...
export function SoundProvider({ children }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('packstack-sound-toggle', handler)
    return () => window.removeEventListener('packstack-sound-toggle', handler)
  }, [])
  ...
  return (
    <SoundContext.Provider value={{ playHover, playClick, enabled }}>
      {children}
